...
for j=1:4
    ...
    legendEntriesPlant{end+1} = "Plant Biomass [g/m^2] (W0=" + w0vec(j) + ")";
...
title("Soil Water Dynamics for different W0 values")
...
title("Plant Biomass Dynamics for different W0 values")
