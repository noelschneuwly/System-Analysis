...
% Purpose: Use this code to determine a potential equilibrium of the model
% using appropriate input variables. The model plots the null-isoclines
% (i.e. the graphs where dW/dt = 0 and dP/dt = 0 respectively. 
...
contour(Wg, Pg, dWdt, [0 0], 'b', 'LineWidth', 3); 
contour(Wg, Pg, dPdt, [0 0], 'r', 'LineWidth', 3); 
yline(0, 'Color', redlight , 'LineWidth', 3)

xlabel('Soil water W');
ylabel('Plant biomass P');
title('Null Isoclines and Equilibrium Point');
legend('W-nullcline (computationally determined)', 'P-nullcline (non-trivial)', 'P-nullcline (trivial)', 'Location', 'NorthEast');
